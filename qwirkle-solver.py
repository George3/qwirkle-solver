...
# !>    # Mom (AI "error"/limitation - Allowed a 1-tile Qwirkle that should have been blocked!)
        ...
        # Mom
        ,(12, 0): Tile(color='green', shape='clover'), (13, 0): Tile(color='green', shape='square')
        # My mv #26 (8 points)
        ,(11, 2): Tile(color='yellow', shape='crossX'), (12, 2): Tile(color='yellow', shape='clover')
        # Mom
        ,(-2, 4): Tile(color='red', shape='clover')
        # My mv #27 (15 points)
        ,(-5, 1): Tile(color='blue', shape='square'), (-5, 2): Tile(color='orange', shape='square')
        # Mom's move
        ,(9, 2): Tile(color='yellow', shape='circle'), (10, 2): Tile(color='yellow', shape='diamond')
        # My mv #28 (8 points)
        ,(12, -1): Tile(color='red', shape='clover'), (13, -1): Tile(color='green', shape='clover')
        # Mom's move
        ...
        ,(9, 1): Tile(color='orange', shape='circle')
         # Mom's move
        ,(-4, 1): Tile(color='blue', shape='star')
        # My mv #31 (11 points)
        ,(10, 3): Tile(color='red', shape='diamond'), (11, 3): Tile(color='red', shape='crossX')
        # Mom's move
        ,(3, 5): Tile(color='orange', shape='square'), (4, 5): Tile(color='blue', shape='square'), (5, 5): Tile(color='yellow', shape='square'), (6, 5): Tile(color='red', shape='square')
        # My mv #32 (12 points)
        ,(11, 4): Tile(color='blue', shape='crossX'), (11, 5): Tile(color='purple', shape='crossX')
    }
